            ...
            <div className="container mx-auto flex justify-center items-center">
              <div className="relative">
                ...
                >
                  {account.chain?.name}
                  <ChevronDown
                    className={`h-5 w-5 transition-transform ${isChainMenuOpen ? 'rotate-180' : ''}`}
                  />
                </Button>
            ...
            <section className="space-y-2">
              <div className="grid grid-cols-4 gap-4">
                <div className="flex flex-col items-center gap-2">
                  <Button
                    variant="outline"
                    className="h-8 w-8 flex items-center justify-center bg-white border-blue-500/30 hover:bg-white text-blue-300 rounded-xl"
                  >
                ...
                <div className="flex flex-col items-center gap-2">
                  <Button
                    variant="outline"
                    className="h-8 w-8 flex items-center justify-center bg-white border-purple-500/30 hover:bg-white text-purple-300 rounded-xl"
                  >
                ...
                <div className="flex flex-col items-center gap-2">
                  <Button
                    variant="outline"
                    className="h-8 w-8 flex items-center justify-center bg-white border-indigo-500/30 hover:bg-white text-indigo-300 rounded-xl"
                  >
                ...
                <div className="flex flex-col items-center gap-2">
                  <Link href="/chat">
                    <Button
                      variant="outline"
                      className="h-8 w-8 flex items-center justify-center bg-white border-cyan-500/30 hover:bg-white text-cyan-300 rounded-xl"
                    >
          ...
          <footer className="p-4">
            <div className="container mx-auto flex flex-col justify-center items-center gap-4">
              <Button
                onClick={() => disconnect()}
                variant="destructive"
                className="bg-gradient-to-r from-amber-50/80 to-amber-100/80 hover:from-amber-100 hover:to-amber-200 border border-amber-200/30 text-amber-900"
              >
                Disconnect Wallet
              </Button>
